				...
				<div class="col-sm-8 single-left">
					<div class="song">
						...
						<c:forEach items="${comments }" var="comment">
							<div class="video-grid-single-page-agileits" style="color: black;">
								${comment.time }&nbsp;&nbsp;<img src="${comment.user.avator }" style="height: 50px;width: 50px;border-radius:50%;" /> 
								&nbsp;${comment.user.id }:${comment.content }
							</div>
						</c:forEach>
						<div class="video-grid-single-page-agileits">
							&nbsp;
						...
						<div class="video-grid-single-page-agileits" >
							<a href="single?id=${movie.id }">返回</a>
						</div>
					</div>
